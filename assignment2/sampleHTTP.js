...
const server = http.createServer((req, res) => {
  //call createServer, get back a server object
...
`;
    ...
    req.on("data", (chunk) => {
      //chunk is the parameter that receives whatever data came with that particular "data" event — in this case, a piece of the raw bytes/string being sent.
    ...
    req.on("end", () => {
      ...
      res.end(
        ...
        JSON.stringify({ weReceived: parseBody }), //build response object → convert to string → send to Postman
